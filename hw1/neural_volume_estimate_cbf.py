...
if __name__ == "__main__":
    ...
    if MODEL == "vf":
        ...
        model = NeuralVF(ckpt_path="outputs/vf.ckpt")

    elif MODEL == "cbf":
        print("Loading neural CBF model...")
        model = NeuralCBF(ckpt_path="outputs/cbf.ckpt")

    else:
        raise ValueError("MODEL must be either 'vf' or 'cbf'.")
