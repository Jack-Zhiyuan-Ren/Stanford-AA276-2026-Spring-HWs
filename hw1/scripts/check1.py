...
with open(os.path.join(_TESTS_DIR, 'part1', 'state_limits_test_cases.pickle'), 'rb') as f:
...
with open(os.path.join(_TESTS_DIR, 'part1', 'control_limits_test_cases.pickle'), 'rb') as f:
...
with open(os.path.join(_TESTS_DIR, 'part1', 'safe_mask_test_cases.pickle'), 'rb') as f:
...
with open(os.path.join(_TESTS_DIR, 'part1', 'failure_mask_test_cases.pickle'), 'rb') as f:
...
print('TESTING g...')
with open(os.path.join(_TESTS_DIR, 'part1', 'g_test_cases.pickle'), 'rb') as f:
