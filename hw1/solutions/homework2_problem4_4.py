print('Run ../hw2/solutions/problem4_4.py to estimate the volume of the safe set for the trained value function model.')
print('Estimating the volume of the safe set for the trained CBF model...')
...
from homework2_problem4_helper import NeuralCBF
...
for i in tqdm(range(n_batches)):
    ...
    num_safe += (neuralcbf.values(x) > 0).sum().item()
